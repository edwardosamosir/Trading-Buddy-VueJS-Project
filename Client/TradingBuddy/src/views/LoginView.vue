...
export default {
  methods:{
    ...mapActions(useTradingStore, ['login', 'googleLogin']),
  ...
  computed : {
    ...mapWritableState(useTradingStore, ['isLogin','email','password'])
  },
         ...
         <div class="card mx-auto" style="max-width: 500px; background-color: #191919;">
           ...
           <div class="card-body">
             <form @submit.prevent="login">
               <h5 class="card-title text-center">Sign in to Trading Buddy</h5>
               <br>
